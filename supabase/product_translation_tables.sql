...
values
  ...
  ('Satin Nike Heel Fabric', 'en', 'Satin Nike Heel Fabric'),
  ('Upper Mesh Fabric', 'en', 'Upper Mesh Fabric'),
  ('Diamond Lattice', 'en', 'Diamond Lattice'),
  ('Terry Cloth Fabric', 'en', 'Terry Cloth Fabric'),
  ...
  ('Satin Nike Heel Fabric', 'zh', '缎面 Nike 后跟布'),
  ('Diamond Lattice', 'zh', '菱形格网布'),
  ('Terry Cloth Fabric', 'zh', '毛巾布面料'),
  ('Zipper Puller Hardware Accessories', 'ko', '지퍼 풀러 금속 부자재'),
  ('Plastic Accessories', 'ko', '플라스틱 부자재'),
  ('Heel Round-Eye Mesh', 'ko', '뒤꿈치 라운드 아이 메쉬'),
  ('Satin Nike Heel Fabric', 'ko', '새틴 나이키 뒤꿈치 원단'),
  ('Diamond Lattice', 'ko', '다이아몬드 격자 메쉬'),
  ('Terry Cloth Fabric', 'ko', '테리직 원단'),
  ('Zipper Puller Hardware Accessories', 'ja', 'ジッパープラー金具部品'),
  ('Plastic Accessories', 'ja', 'プラスチック部品'),
  ('Heel Round-Eye Mesh', 'ja', 'ヒール用丸目メッシュ'),
  ('Satin Nike Heel Fabric', 'ja', 'サテンNikeヒール生地'),
  ('Diamond Lattice', 'ja', 'ダイヤ格子メッシュ'),
  ('Terry Cloth Fabric', 'ja', 'テリークロス生地'),
